...
Source0  : https://download.gnome.org/sources/gnome-contacts/3.36/gnome-contacts-3.36.tar.xz
...
%prep
%setup -q -n gnome-contacts-3.36
cd %{_builddir}/gnome-contacts-3.36
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586204518
...
cp %{_builddir}/gnome-contacts-3.36/COPYING %{buildroot}/usr/share/package-licenses/gnome-contacts/2c026582eb07be6897378e91a8c8c76fee512d72
cp %{_builddir}/gnome-contacts-3.36/subprojects/libhandy/COPYING %{buildroot}/usr/share/package-licenses/gnome-contacts/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/gnome-contacts-3.36/subprojects/libhandy/debian/copyright %{buildroot}/usr/share/package-licenses/gnome-contacts/d295f3a9ec2407b00d9f397ce11fb432ae071dd2
