...
Version  : 48.0
Release  : 63
URL      : https://download.gnome.org/sources/gnome-contacts/48/gnome-contacts-48.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-contacts/48/gnome-contacts-48.0.tar.xz
...
%prep
%setup -q -n gnome-contacts-48.0
cd %{_builddir}/gnome-contacts-48.0
pushd ..
cp -a gnome-contacts-48.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742595227
...
/usr/share/metainfo/org.gnome.Contacts.metainfo.xml
