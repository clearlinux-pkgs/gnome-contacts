...
Version  : 45.1
Release  : 50
URL      : https://download.gnome.org/sources/gnome-contacts/45/gnome-contacts-45.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-contacts/45/gnome-contacts-45.1.tar.xz
...
%prep
%setup -q -n gnome-contacts-45.1
cd %{_builddir}/gnome-contacts-45.1
pushd ..
cp -a gnome-contacts-45.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709739634
