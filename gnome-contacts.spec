...
%prep
%setup -q -n gnome-contacts-40.0
cd %{_builddir}/gnome-contacts-40.0
...
cp %{_builddir}/gnome-contacts-40.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-contacts/2c026582eb07be6897378e91a8c8c76fee512d72
