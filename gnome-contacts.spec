...
%prep
%setup -q -n gnome-contacts-3.38
cd %{_builddir}/gnome-contacts-3.38
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600650305
...
cp %{_builddir}/gnome-contacts-3.38/COPYING %{buildroot}/usr/share/package-licenses/gnome-contacts/2c026582eb07be6897378e91a8c8c76fee512d72
cp %{_builddir}/gnome-contacts-3.38/subprojects/libhandy/COPYING %{buildroot}/usr/share/package-licenses/gnome-contacts/01a6b4bf79aca9b556822601186afab86e8c4fbf
