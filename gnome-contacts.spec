...
Version  : 47.1.1
Release  : 61
URL      : https://download.gnome.org/sources/gnome-contacts/47/gnome-contacts-47.1.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-contacts/47/gnome-contacts-47.1.1.tar.xz
...
%prep
%setup -q -n gnome-contacts-47.1.1
cd %{_builddir}/gnome-contacts-47.1.1
pushd ..
cp -a gnome-contacts-47.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735605809
