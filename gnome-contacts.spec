...
Version  : 42.0
Release  : 18
URL      : https://download.gnome.org/sources/gnome-contacts/42/gnome-contacts-42.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-contacts/42/gnome-contacts-42.0.tar.xz
...
%prep
%setup -q -n gnome-contacts-42.0
cd %{_builddir}/gnome-contacts-42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648495836
...
cp %{_builddir}/gnome-contacts-42.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-contacts/2c026582eb07be6897378e91a8c8c76fee512d72
