...
Version  : 47.0
Release  : 56
URL      : https://download.gnome.org/sources/gnome-contacts/47/gnome-contacts-47.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-contacts/47/gnome-contacts-47.0.tar.xz
...
%prep
%setup -q -n gnome-contacts-47.0
cd %{_builddir}/gnome-contacts-47.0
pushd ..
cp -a gnome-contacts-47.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726762965
